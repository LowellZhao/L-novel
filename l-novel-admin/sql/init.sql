...
VALUES ('书趣阁', '{\"charset\": \"UTF-8\", \"descEnd\": \"最新章节推荐地址\", \"descStart\": \"<div class=\\\"intro_info\\\">\", \"webPreUrl\": \"https://wap.shuquge.com\", \"contentEnd\": \"</div>\", \"bookListUrl\": \"https://wap.shuquge.com/sort/{cid}/0_{page}.html\", \"categoryUrl\": \"https://wap.shuquge.com/sort/\", \"bookIdPatten\": \"href=\\\"/s/(\\\\d+)\\\\.html\\\"\", \"contentStart\": \"<div id=\\\"nr1\\\">\", \"picUrlPatten\": \"<img\\\\s+src=\\\"(https://www.shuquge.com/files/article/image/\\\\d+/\\\\d+/\\\\d+s.jpg)\\\"\", \"bookDetailUrl\": \"https://wap.shuquge.com/s/{bookId}.html\", \"indexIdPatten\": \"<li><a\\\\s+href=\\\"/chapter/\\\\d+_(\\\\d+).html\\\">[^/]+</a></li>\", \"bookContentUrl\": \"https://wap.shuquge.com/chapter/{bookId}_{indexId}.html\", \"bookIndexStart\": \"正文\", \"bookNamePatten\": \"<a\\\\s+href=\\\"/s/\\\\d+\\\\.html\\\"><h2>([^/]+)</h2></a>\", \"nextPagePatten\": \"<a\\\\s+id=\\\"pb_next\\\"\\\\s+href=\\\"/chapter/\\\\d+_(\\\\d+_\\\\d+).html\\\">下一页</a>\", \"indexNamePatten\": \"<li><a\\\\s+href=\\\"/chapter/\\\\d+_\\\\d+.html\\\">([^/]+)</a></li>\", \"authorNamePatten\": \"<p>作者：([^/]+)</p>\", \"categoryIdPatten\": \"<li\\\\s+class=\\\"prev\\\"><a[^/]+href=\\\"/sort/(\\\\d+)/0_1.html\\\">[^/]+</a></li>\", \"contentPattenMap\": {\"[(]第\\\\d+/\\\\d+页[)]\": \"\", \"（本章未完，请点击下一页继续阅读）\": \"\"}, \"categoryNamePatten\": \"<li\\\\s+class=\\\"prev\\\"><a[^/]+href=\\\"/sort/\\\\d+/0_1.html\\\">([^/]+)</a></li>\", \"nextIndexUrlPatten\": \"<a\\\\s+href=\\\"(/d/\\\\d+_\\\\d+.html)\\\"\\\\s+class=\\\"onclick\\\">下一页</a>\", \"detailCategoryNamePatten\": \"<p>分类：<a\\\\s+href=\\\"/sort/\\\\d+/0_1.html\\\">([^/]+)</a></p>\"}', '1');
INSERT INTO `l_novel`.`t_crawl_source` (`name`, `rule`, `status`)
VALUES ('新笔趣阁', '{\"charset\": \"gbk\", \"descEnd\": \"\\\"/>\", \"descStart\": \"<meta property=\\\"og:description\\\" content=\\\"\", \"contentEnd\": \"</div>\", \"bookListUrl\": \"http://www.newbiquge.com{cid}\", \"categoryUrl\": \"http://www.newbiquge.com/\", \"bookIdPatten\": \"《<a\\\\s+href=\\\"http://www.newbiquge.com/book/(\\\\d+).html\\\"\\\\s+target=\\\"_blank\\\">[^/]+</a>》\", \"contentStart\": \"<div id=\\\"content\\\">\", \"picUrlPatten\": \"<img src=\\\"(http://www.newbiquge.com/files/article/image/.+jpg)\\\"\", \"bookDetailUrl\": \"http://www.newbiquge.com/book/{bookId}.html\", \"contentNeedJs\": true, \"indexIdPatten\": \"<dd><a\\\\s+href=\\\"(/.+).html\\\">[^/]+</a></dd>\", \"bookContentUrl\": \"http://www.newbiquge.com{indexId}.html\", \"bookNamePatten\": \"<h1>([^/]+)</h1>\", \"indexNamePatten\": \"<dd><a\\\\s+href=\\\"/.+.html\\\">([^/]+)</a></dd>\", \"authorNamePatten\": \"<p>作者：<a.+>([^/]+)</a></p>\", \"categoryIdPatten\": \"<li><a\\\\s+href=\\\"(/\\\\w+/)\\\">[^/]+</a></li>\", \"contentPattenMap\": {\"\\n\\n\": \"\\n\", \"\\r\\n\": \"\\n\"}, \"categoryNamePatten\": \"<li><a\\\\s+href=\\\"/\\\\w+/\\\">([^/]+)</a></li>\", \"indexIdSortPattern\": \"/\\\\d+/\\\\d+/(\\\\d+)\", \"detailCategoryNamePatten\": \"<meta property=\\\"og:novel:category\\\" content=\\\"([^/]+)\\\"/>\"}', '1');
